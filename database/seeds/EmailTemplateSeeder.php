...
class EmailTemplateSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $templates = [
            ...
            $key.'new_user_created' => 'A new user ([user:first_name] [user:last_name] ) has been created.',
            $key.'new_project_created' => 'A new project ([project:title]) has been created by [project:creator:first_name]',

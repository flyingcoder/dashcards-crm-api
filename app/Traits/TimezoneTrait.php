...
trait TimezoneTrait
{
    protected $timezones = array(
        'UTC' => '(GMT+0:00) UTC (Coordinated Universal Time)',
    ...
    public function splitZonesAndStandards()
    {
        $splitZoneInfo = [];
        foreach ($this->timezones as $t => $z) {
            $label = $z;
     ...
     * @return string
     */
    public function toUTC(string $base_timezone, string $datetime)
    {
        if (strtolower($base_timezone) == 'utc')
            return Carbon::createFromFormat('Y-m-d H:i:s', $datetime, 'UTC');

        $date = Carbon::createFromFormat('Y-m-d H:i:s', $datetime, $base_timezone);

        ...
        <v-layout row wrap>
            <div class="content-header col-md-6">
                <div class="page-title">
                    <h1> <span class="prev-path"> Dashboard </span> &nbsp; <img src="/img/icons/ArrowRight.svg"> &nbsp; <span class="current"> Invoice </span> </h1>
                </div>
            </div>
            <div class="col-md-6">
                <div class="head-page-option">
                    <ul class="nav nav-tabs">
                        <li>
                            <div class="add-button" v-on:click="invoiceForm">
                                <span> ADD NEW </span>
                                <button>

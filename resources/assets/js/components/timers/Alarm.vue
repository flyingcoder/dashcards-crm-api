<template>
    <section class="tab-pane fade alarm-table" id="alarm">
        <div class="content-header">
            <div class="row">
                <div class="col-md-6">
                    <div class="page-title">
                        <h1> <span class="prev-path"> Dashboard </span> &nbsp; <img src="img/icons/ArrowRight.svg"> &nbsp; <span class="current"> Alarm </span> </h1>
                    </div>
                </div>
                <div class="col-md-6">
                        ...
                        <ul class="nav nav-tabs">
                            <li>
                                <div class="add-button">
                                    <span> ADD NEW </span>
                                    <button  @click="$modal.show('add-alarm')">
        ...
        <div class="content-body">
            <section class="buzz-section">
                <div class="buzz-table">
                    <div class="Alarm">
                        <div v-if="paginatedAlarms.length >= 1">
                            <el-table :data="paginatedAlarms" stripe empty-text="No Data Found" v-loading="isProcessing" 
                            ...
                            >
                                ...
                                <el-table-column sortable prop="events" label="Events"></el-table-column>
                                <el-table-column sortable prop="service_name" label="Services"></el-table-column>
...
<script>
    import EmptyAlarm from './EmptyAlarm.vue';

    export default {   
        components: {
          'empty-alarm': EmptyAlarm,
      },
      data () {
        return {
        isProcessing: false,
      ...
      methods: {
        ...
        getAllAlarms(){
            ...
            .then( response => {
                this.paginatedAlarms = response.data.data;

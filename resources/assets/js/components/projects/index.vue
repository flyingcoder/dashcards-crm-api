                ...
                <div class="buzz-table">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade tab-table" id="all-project">
                            <el-row>
                                <el-table :data="paginatedProjects" border stripe empty-text="No Data Found" v-loading="isProcessing" 
                                @sort-change="handleSortChange" element-loading-text="Processing ..." @selection-change="handleSelectionChange" style="width: 100%">
                                    ...
                                    <el-table-column sortable prop="service" label="Code" min-width="180"></el-table-column>
                                    <el-table-column sortable prop="client" label="Name" min-width="180"></el-table-column>
                                    <el-table-column sortable prop="Project Manager" label="Description" min-width="280" :show-overflow-tooltip="true"></el-table-column>
                                    <el-table-column sortable prop="Start Date" label="Description" min-width="280" :show-overflow-tooltip="true"></el-table-column>
                                    <el-table-column sortable prop="Progress" label="Description" min-width="280" :show-overflow-tooltip="true"></el-table-column>
                                    <el-table-column sortable prop="Time Spent" label="Description" min-width="280" :show-overflow-tooltip="true"></el-table-column>
                                    <el-table-column sortable prop="Status" label="Description" min-width="280" :show-overflow-tooltip="true"></el-table-column>
                            ...
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td> <img src="img/temporary/user1.png"> </td>
                                        <td>  <span> 17.05.2017 </span> </td>
                                        <td>
                                            <div class="progress project-progress"> 
                                                <div class="progress-bar" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </td>
                                        <td> <span> 01:10:05 </span> </td>
                                        <td> 
                                            <span class="status"> Active </span>
                                            <div class="progress project-status active"> </div>
                                        </td>
                                        <td> 
                                            <a href="#">
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"

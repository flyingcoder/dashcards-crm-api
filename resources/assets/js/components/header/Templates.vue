                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <button class="template-box" v-bind:class="isActive('payment')"
                            ...
                            <div class="template-image">
                                <svg viewBox="0 0 114.974 78.969"  width="70px">
